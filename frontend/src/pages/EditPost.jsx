...
const EditPost = () => {
  ...
  return (
    ...
    <div className='px-6 md:px-[200px] mt-8'>
        <h1 className='font-bold mt-8 md:text-2xl text-xl '>Edit a post</h1>
        <form action='' className='w-full flex mt-4 flex-col space-y-4 md:space-y-8'>
            ...
            <button className='bg-black rounded-lg w-full mdLw-[20%] px-4 py-2 md:text-xl text-lg mx-auto text-white font-semibold '>Update</button>
        </form>
    </div>
    <Footer />
</div>
