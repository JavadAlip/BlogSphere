...
//       <input onChange={(e)=>setUsername(e.target.value)} className='w-full px-4 py-4 rounded-full border-2 border-black outline-0' type='text' placeholder='Username'/>
...
//       <button onClick={handleRegister} className='w-full px-4 py-4 font-bold text-white hover:bg-gray-500 hover:text-black bg-black rounded-full'>Register</button>
//       {error && <h3 className='text-red-500 text-sm'>Try another details!</h3>}
